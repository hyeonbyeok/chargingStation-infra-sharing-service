...
<style>
	...
	#menu_wrap {padding:5px;overflow-y:auto;background:rgba(255, 255, 255, 0.7);z-index: 1;font-size:12px;border-radius: 10px;}
					...
					<div class="search_wrap">
						...
						<div class="check_box_wrap">
							...
							<div class="check_two">
								<h5>충전 타입</h5>
								<div class="slsl">
									<input type="checkbox" id="typeAll" class="chk">
									<label>전체</label>
								</div>
								<div class="slsl">
									<input type="checkbox" id="type1" class="chk type" value="DC콤보">
									<label>DC콤보</label>
								</div>
								<div class="slsl">
									<input type="checkbox" id="type2" class="chk type" value="DC차데모">
									<label>DC차데모</label>
								</div>
								<div class="slsl">
									<input type="checkbox" id="type3" class="chk type" value="AC3상">
									<label>AC3상</label>
								</div>
								<div class="slsl">
									<input type="checkbox" id="type4" class="chk type" value="AC완속">
									<label>AC완속</label>
								</div>
							</div>
						</div>
					...
					<div class="map_wrap">
						...
						<div style="display: flex;">
							...
							<script>
								...
								positions.push({
									title: '${item.name}',
									content: '<div style="width:150px; padding:5px;">${item.name}</div>',
